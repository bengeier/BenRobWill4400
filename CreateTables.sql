...
FOREIGN KEY (`UserEmail`) REFERENCES `RateACity`.`USER` (`Email`) ON UPDATE CASCADE ON DELETE CASCADE,
FOREIGN KEY (`ReviewableEID`) REFERENCES `RateACity`.`REVIEWABLE_ENTITY` (`EntityID`) ON DELETE CASCADE,
...
PRIMARY KEY (`CityEID`),
FOREIGN KEY (`CityEID`) REFERENCES `RateACity`.`REVIEWABLE_ENTITY` (`EntityID`) ON DELETE CASCADE);
...
FOREIGN KEY (`AttractionEID`) REFERENCES `RateACity`.`REVIEWABLE_ENTITY` (`EntityID`) ON DELETE CASCADE,
...
FOREIGN KEY (`AttractionEID`) REFERENCES `RateACity`.`ATTRACTION` (`AttractionEID`) ON DELETE CASCADE,
FOREIGN KEY (`CName`) REFERENCES `RateACity`.`CATEGORY` (`CName`) ON DELETE CASCADE ON UPDATE CASCADE );
